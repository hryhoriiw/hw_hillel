...
// const howManyYears = parseInt(prompt('Скільки тобі років?'));
// const whereFrom = prompt('Звідки ти?');
// const favoriteSport = prompt('Який в тебе найулюбленіший вид спорту?');

// alert('Тобі зараз ' + howManyYears + ' років');

// const capitalCountryPairs = {
//     'Київ': 'Україна',
//     'Вашингтон': 'США',
//     'Лондон': 'Велика Британія'
// };

// let isCapital = whereFrom === 'Київ' || whereFrom === 'Вашингтон' || whereFrom === 'Лондон';
// let country = isCapital ? capitalCountryPairs[whereFrom] : '';

// if (isCapital) {
//     alert('Ти живеш у столиці ' + whereFrom + ', країна - ' + country);
// } else {
//     alert('Ти живеш у місті ' + whereFrom);
// }
